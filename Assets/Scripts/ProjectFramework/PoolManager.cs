...
namespace FrameWork
{
    ...
    public class PoolManager : SingletonManager<PoolManager>
    {
        ...
        {
            _poolDic.ClearNullKeys();
            _returnDic.ClearNullKeys();
            _poolObjectDic.ClearNullKeys();
        ...
        public void DicClearNullKeys<T> (Dictionary<GameObject, T> dic)
        {
